/*
 * jdigiFlipClock plugin 2.1
 *
 * http://www.radoslavdimov.com/jquery-plugins/jquery-plugin-digiFlipClock/
 *
...
(function($) {
    $.fn.extend({
        jdigiFlipClock: function(options) {
			var defaults = {
                clockImagesPath: 'plugins/FlipClock/core/template/dashboard/images/clock1/',
                lang: 'fr'             
            };
